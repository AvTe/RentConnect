  ...
  return (
    <div className="h-[100dvh] w-screen bg-white font-sans overflow-hidden flex flex-col">
      ...
      <footer className="bg-white border-t border-gray-100 py-3">
        <div className="max-w-[1400px] mx-auto px-4 flex flex-col sm:flex-row items-center justify-center gap-1 sm:gap-4 text-xs text-gray-500">
          <nav aria-label="Legal" className="flex items-center gap-3">
            <a href="https://www.yoombaa.com/privacy-policy" className="hover:text-[#FE9200] transition-colors underline">Privacy Policy</a>
            <span className="text-gray-300">|</span>
            <a href="https://www.yoombaa.com/terms-of-service" className="hover:text-[#FE9200] transition-colors underline">Terms of Service</a>
            <span className="text-gray-300">|</span>
            <a href="https://www.yoombaa.com/contact" className="hover:text-[#FE9200] transition-colors">Contact Us</a>
          </nav>
