...
// Sender email addresses - Using verified yoombaa.com domain
// Make sure the domain is verified in Resend dashboard
const DEFAULT_FROM = process.env.RESEND_FROM_EMAIL || 'Yoombaa <noreply@yoombaa.com>';
const SUPPORT_FROM = process.env.RESEND_SUPPORT_EMAIL || 'Yoombaa Support <support@yoombaa.com>';
